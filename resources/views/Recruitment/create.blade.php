            ...
            <div class="step-content" id="step-content-1">
              ...
              <div style="display: flex; justify-content: space-between; align-items: center; width: 100%; flex-wrap: wrap;">
                  <div class="right-section2">
                      ...
                      <button type="button" class="btn btn-primary btn-next" data-step="1">Selanjutnya</button>
            ...
            <div class="step-content d-none" id="step-content-2">
              ...
              <div style="display: flex; justify-content: space-between; align-items: center; width: 100%; flex-wrap: wrap;">
                  <div class="right-section2">
                      ...
                      <button type="button" class="btn btn-primary btn-next" data-step="2">Selanjutnya</button>
...
document.addEventListener("DOMContentLoaded", function () {
    // semua tombol next step
    document.querySelectorAll(".btn-next").forEach(btn => {
        btn.addEventListener("click", function () {
            let currentStep = parseInt(this.getAttribute("data-step"));
            let currentStepEl = document.getElementById(`step-content-${currentStep}`);
            ...
            let nextStepEl = document.getElementById(`step-content-${currentStep + 1}`);
            if (nextStepEl) {
