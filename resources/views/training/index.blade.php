...
<!-- KONTEN UTAMA -->
<div id="sedangBerjalan" class="tab-content content-header-flex overflow-x-hidden" style="width:160vh; margin-left: 42vh;">
...
<div id="trainingNeedsAnalysis" class="tab-content content-header-flex hidden" style="width:160vh; margin-left: 42vh; display:none;">
  ...
  <div class="stat-boxes2 w-full">
    ...
    <div class="stat-box2 px-3 py-2">
      ...
      <div class="stat-info">
        <div class="stat-value font-bold">{{ number_format($persenTna, 2) }}%</div>
  ...
  <div class="overflow-x-scroll" style="max-width: 153vh; ">
    <table id="customers" style="min-width: 1200px;">
      <tr>
        <th class="sticky left-0 z-20 bg-gray-100 px-3 py-1 border-b">No</th>
        <th class="px-3 py-1 text-right whitespace-nowrap">
          Tahun
        ...
        <th class="px-3 py-1 text-right whitespace-nowrap">
          Biaya
          <a href="{{ route('training.index', [
          'sort_by_training'   => 'biaya',
          'sort_order_training'=> ($sortByTraining == 'biaya' && $sortOrderTraining == 'asc') ? 'desc' : 'asc'
      ]) }}#trainingNeedsAnalysis">
            {!! $sortByTraining == 'biaya' ? '⇅' : '⇅' !!}
        </th>
        <th class="px-3 py-1 text-right whitespace-nowrap">
          Prioritas
          <a href="{{ route('training.index', [
