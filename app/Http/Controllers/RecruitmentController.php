...
class RecruitmentController extends Controller
{
    ...
    public function store(Request $request) {
        $request->validate([
            ...
            'unitSub' => 'required|nullable|string',
            'band_posisi' => 'required|nullable|string',
            'status_kepegawaian' => 'required|nullable|string',
            'lokasi_pekerjaan' => 'required|nullable|string',
            'medis_non_medis' => 'required|nullable|string',
            'jumlah_lowongan' => 'required|nullable|string',
            'target_tanggal' => 'required|nullable|date',
            'hiring_manager' => 'required|nullable|string',
            'nde' => 'required|nullable|string',
